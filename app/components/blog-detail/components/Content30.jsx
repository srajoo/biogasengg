      ...
      <div className="container">
        <div className="mx-auto max-w-lg">
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="grow">
              <p className="text-medium font-semibold">Sarah Chen</p>
              <p>
                Senior Process Engineer at BGE Energy with extensive experience
                in renewable natural gas project development and implementation.
              </p>
            </div>
          </div>
        </div>
